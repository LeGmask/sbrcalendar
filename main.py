...
def checkForDuplicate(course: Course):
...
for config in configs:
    ...
    for i in range(190):
        ...
        start = datetime.datetime(day.year, day.month, day.day).astimezone(
        ...
        for course in courses:
            if actual_events and not checkForDuplicate(course) or not actual_events:
